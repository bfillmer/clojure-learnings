...
return (function (p__9941){
var vec__9942 = p__9941;
var attr = cljs.core.nth.call(null,vec__9942,(0),null);
...
var args9945 = [];
var len__8226__auto___9948 = arguments.length;
var i__8227__auto___9949 = (0);
while(true){
if((i__8227__auto___9949 < len__8226__auto___9948)){
args9945.push((arguments[i__8227__auto___9949]));

var G__9950 = (i__8227__auto___9949 + (1));
i__8227__auto___9949 = G__9950;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args9945.length)].join('')));
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8234__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9952){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9952));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9956){
var map__9960 = p__9956;
var map__9960__$1 = ((((!((map__9960 == null)))?((((map__9960.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9960.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9960):map__9960);
var data = map__9960__$1;
var message = cljs.core.get.call(null,map__9960__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9960__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9960__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9962 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9962,goog.events.EventType.CLICK,((function (G__9962,map__9960,map__9960__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9962,map__9960,map__9960__$1,data,message,line,file))
);

return G__9962;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9963){
var map__9967 = p__9963;
var map__9967__$1 = ((((!((map__9967 == null)))?((((map__9967.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9967.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9967):map__9967);
var data = map__9967__$1;
var message = cljs.core.get.call(null,map__9967__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9967__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9967__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9969 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str.cljs$core$IFn$_invoke$arity$1("at line "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__9969,goog.events.EventType.CLICK,((function (G__9969,map__9967,map__9967__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9969,map__9967,map__9967__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9970){
var map__9974 = p__9970;
...
var messages = map__9974__$1;
var warnings = cljs.core.get.call(null,map__9974__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9974__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__9976 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9976,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9976,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9977){
var map__9980 = p__9977;
...
var messages = map__9980__$1;
var warnings = cljs.core.get.call(null,map__9980__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9980__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9980,map__9980__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9980,map__9980__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9980,map__9980__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9980,map__9980__$1,messages,warnings,exception))
;
